...
def get_cpu_tdp(cpu_name: str) -> float:
    ...
    path = os.path.join(
        os.path.dirname(os.path.dirname(__file__)).split("utils")[0], "data"
    )
...
# get_cpu_tdp("Intel(R) Core(TM) i7-10700K CPU @ 3.80GHz")
